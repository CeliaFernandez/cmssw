...
displacedMuons1stStep = cms.EDProducer("MuonIdProducer",
...
run3_GEM.toModify( displacedMuons1stStep, TrackAssociatorParameters = dict(useGEM = True ) )
from Configuration.Eras.Modifier_phase2_muon_cff import phase2_muon
phase2_muon.toModify( displacedMuons1stStep, TrackAssociatorParameters = dict(useME0 = True ) )
from Configuration.Eras.Modifier_phase2_GE0_cff import phase2_GE0
phase2_GE0.toModify( displacedMuons1stStep, TrackAssociatorParameters = dict(useME0 = False ) )

muonEcalDetIds = cms.EDProducer("InterestingEcalDetIdProducer",
                                inputCollection = cms.InputTag("displacedMuons1stStep")
)

from Configuration.ProcessModifiers.pp_on_AA_cff import pp_on_AA
pp_on_AA.toModify(displacedMuons1stStep, minPt = 0.8)

from Configuration.ProcessModifiers.recoFromReco_cff import recoFromReco
recoFromReco.toModify(displacedMuons1stStep,fillShowerDigis = False)
